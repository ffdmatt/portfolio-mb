...
const resumeData: ResumeData = {
  ...
  summary: "I am best described as a digital marketer crossed with a programmer. I use my unique blend of talents to share engaging stories, create unique tools and designs, and connect people with the products and services that help them.",
  experiences: [
    {
  ...
  skillGroups: [
    ...
    {
      groupName: "Office / Software Skills",
      skills: [
        ...
        {
          name: "Project Management Tools, including Monday and Asana",
          level: "Advanced",
        },
